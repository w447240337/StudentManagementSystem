...
<html>
  ...
  <%
   ...
   %>
  <body topmargin="60">
    <form name="form" action="save.do?id=<%=cation.getId()%>" method="post">
    <TABLE align="center" border="1" cellSpacing="0" borderColorLight="#c0c0c0" 
      borderColorDark="#ffffff" width="576" bgColor="#f0f5fd"  cellPadding="4">
        <TBODY>
        <TR>
          <TD bgColor=#c1dcff colSpan=7><FONT style="FONT-SIZE: 9pt">请修改您的</FONT>
          <FONT style="FONT-SIZE: 9pt" color=#ff0000>请假信息：</FONT>
          </TD>
        </TR>
        <TR>
          <TD width="150" align="center"><FONT style="FONT-SIZE: 9pt">学科</FONT></TD>
          <TD width="126"><input name="teachclass" size="27" value="<%=cation.getTeachclass()%>"></TD>
          <td colspan="2"><input name="xuehao" type="hidden"  value="<%=(String)session.getAttribute("xuehao") %>"></td>
        </TR>
        <TR>
          <td width="150" align="center"><FONT style="FONT-SIZE: 9pt">开始时间</FONT></td>
          <td width="100"><input name="begintime" size="27" value="<%=cation.getBegintime()%>"></td>
          <td width="150" align="center"><FONT style="FONT-SIZE: 9pt">结束时间</FONT></td>
          <td width="100"><input name="overtime" size="27" value="<%=cation.getOvertime() %>"></td>
        </TR>
        <TR>
          <TD height="20" width="200" align="center"><FONT style="FONT-SIZE: 9pt">请假原因:</FONT></TD>
          <td colspan="3">&nbsp;</td>
        </TR>
        <TR>
          <td width="150">&nbsp;</td>
          <TD align="left" colSpan="3"><textarea style="HEIGHT: 100px" rows="3" cols="58" name="reason"><%=cation.getReason() %></textarea>
          </TD>
        </TR>
        <tr>
