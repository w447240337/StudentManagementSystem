...
<body topmargin="60">
	<form name="form" action="qingjia.do" method="post">
		<TABLE align="center" border="1" cellSpacing="0"
			borderColorLight="#c0c0c0" borderColorDark="#ffffff" width="600"
			bgColor="#f0f5fd" cellPadding="4">
			<TBODY>
				<TR>
					<TD bgColor=#c1dcff colSpan=7><FONT style="FONT-SIZE: 9pt">请填写您的</FONT>
						<FONT style="FONT-SIZE: 9pt" color=#ff0000>请假信息：</FONT></TD>
				</TR>
				<TR>
					<TD width="150" align="center"><FONT style="FONT-SIZE: 9pt">学科:</FONT></TD>
					<TD width="126"><input name="teachclass" size="27"></TD>
					<td colspan="2"><input name="xuehao" type="hidden"
						value="<%=id%>"></td>
					<td colspan="2"><input name="name" type="hidden"
						value="<%=(String)session.getAttribute("name") %>"></td>
				</TR>
				<TR>
					<td align="center" colspan="4"><FONT style="FONT-SIZE: 9pt"
						color=#ff0000>*****时间请按格式YYYY.MM.DD填写*****</FONT></td>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD align="left" colSpan="3"><textarea style="HEIGHT: 100px"
							rows="3" cols="58" name="reason"></textarea></TD>
				</TR>
				<tr>
					<td align="center" colspan="4"><input type="submit"
						name="submit" value="提交" size="15"
						style="background-color: #669900; height: 30px; width: 80px"></td>
				</tr>
			</TBODY>
		</TABLE>
	</form>
